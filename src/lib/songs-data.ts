...
Take em all on a loop`,
  ...
  {
    songNumber: 6,
    songName: "Books of Apocraphy",
    description: "A deep dive into the hidden knowledge systems that Babylon uses to maintain control. Books of Apocraphy exposes the false prophets, prosperity preachers, and intellectual elites who serve as Babylon's agents.",
    linkToWebsite: "/memetic-weapons",
    lyrics: `You don't come back
Had to son lack,
Had to bun that,
Where the funds at

Call back,
Spin around pull back,
See them boys it's all cap,
I know they ain't got all that,
All I say is all facts,
Real stats,
Real maps,
Navigated past the all black,
Cremated all the false crap,

Even demons had to fall back,
state of being detach,
Let it die and turn to ash,
In your mind a bunch of crap,
There's a junkie on an I Phone,
They're looking irate and prideful,
Any damage hold you libel,
And then they profess the bible,
But instead they're very spiteful,
Div and conquer is their title,
They cannot takeoff the blindfold,
Plato's caves is so insightful,
They see the shadows blue and red and then that's what they live their life for,
But it's stealing up their life force,
I thought

Whatcha watcher call that
I call them leeches,
See your sitting in a meeting,
To plan another meeting,
Josh is there he's seething,
He hates everyone that's breathing,
Chip on his shoulder from the times he got a beating,
But Josh ain't into speaking,
He don't want spiritual healing,
He makes sure that the company can keep,
Stealing,
Leeching,
Prosperity preaching,
He's thinking that he's Jesus,
Jesus,
Them are the meeker,

G3 wakes the sleepers,
Parse the fire from the Eteher,
Liars from the teachers,

there are corpses piled high in the street,
On the wall and with their teeth,
They devour people's needs,
Then they speculate on seeds,
That can make a person bleed,
Funding wars and self-fulfilling prophecies,
These are their books of apocryphal y
Cutting philosophy,
Theory into practice or please do not come up to me,
Lovingly,
Of course it's all lovingly`,
    audioFile: "/audio/G3PP - EM - SoundLoadMate.com.mp3",
    coverArt: "/images/cover-art/recursive-memetic-weapons-1.png"
  },
  {
    songNumber: 7,
    songName: "Loopmind",
...
I'm just speaking very practical X2`,
  ...
  {
    songNumber: 8,
    songName: "Aimless Routes Meet the G3 Bout",
...
Creed been sent,`,
  ...
  {
    songNumber: 9,
    songName: "Protocol Dual Collapse",
    description: "A comprehensive analysis of how Babylon's structural poverty and systemic corruption lead to inevitable collapse. Protocol Dual Collapse documents the precise mechanisms of civilizational failure while showing how Genesis systems provide the only viable alternative.",
