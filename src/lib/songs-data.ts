...
export const songs: Song[] = [
  {
    songNumber: 1,
    songName: "G3 Bedouin Blind Plays RSCC For Kronos' Eulogy",
    description: "A powerful opening track that establishes the Genesis philosophy through deep recursive patterns. This song introduces the concept of RSCC (Recursive Stabilized Civilizational Code) and explores the eulogy for Kronos, representing the death of old systems and the birth of new paradigms.",
    linkToWebsite: "/genesis-protocol",
    lyrics: `[Lyrics for G3 Bedouin Blind Plays RSCC For Kronos' Eulogy will be added here]`,
    audioFile: "/audio/G3 Bedouin Blind Plays RSCC For Kronos' Eulogy - ESM.mp3",
    coverArt: "/images/cover-art/g3-bedouin-cover.png"
  },
  {
    songNumber: 2,
