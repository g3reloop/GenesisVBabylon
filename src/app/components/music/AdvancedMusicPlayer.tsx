...
export default function AdvancedMusicPlayer({
  ...
  return (
    <div 
      ...
      tabIndex={0}
    >
      <div className={`max-w-7xl mx-auto px-4 py-3 ${isFullscreen ? 'h-full flex flex-col' : ''}`}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={onPlayPause}
              className="w-12 h-12 bg-white text-emerald-900 rounded-full flex items-center justify-center hover:scale-105 transition-transform"
        ...
        <div className="mt-3">
          <div
            ref={progressRef}
            className="w-full h-1 bg-emerald-700 rounded-full cursor-pointer group"
          ...
          >
            ...
            >
              <div className="w-3 h-3 bg-white rounded-full -mt-1 float-right opacity-0 group-hover:opacity-100 transition-opacity" />
            </div>
          </div>
