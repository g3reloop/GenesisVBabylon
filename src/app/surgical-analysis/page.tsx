...
export default function SurgicalAnalysis() {
  return (
    <PageWithBackground sectionId="surgical-analysis">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          <GlassCard className="mb-8">
            <h1 className="text-5xl font-bold text-cloud-white mb-6 font-recursive drop-shadow-lg genesis-text-glow">
            ...
            <GlassCard className="mb-8">
              ...
              <div className="bg-emerald-900/20 rounded-lg p-6 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="text-lg font-semibold text-plasma-green mb-3">Algorithm Structure</h4>
                    <ul className="text-cloud-white/80 space-y-2 text-sm">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-plasma-green mb-3">Measurable Evidence</h4>
                    <ul className="text-cloud-white/80 space-y-2 text-sm">
              ...
              <div className="bg-red-900/20 rounded-lg p-6 mb-6">
                ...
                <ol className="text-cloud-white/80 space-y-2 text-sm">
            ...
            <GlassCard className="mb-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="glass-container rounded-lg p-6">
                  <h3 className="text-2xl font-semibold text-plasma-green mb-4">1. Lack: Artificial Scarcity Algorithm</h3>
                  
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold text-green-300 mb-3">Technical Implementation</h4>
                    <p className="text-cloud-white/90 text-sm mb-3">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-cloud-white/70 text-xs">
                  ...
                  <div className="bg-red-900/20 rounded-lg p-4">
                    ...
                    <ul className="text-cloud-white/80 text-xs space-y-1">
                ...
                <div className="glass-container rounded-lg p-6">
                  <h3 className="text-2xl font-semibold text-plasma-green mb-4">2. Attachment: Dependency Algorithm</h3>
                ...
                <div className="glass-container rounded-lg p-6">
                  <h3 className="text-2xl font-semibold text-plasma-green mb-4">3. Control: Hierarchical Algorithm</h3>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="glass-container rounded-lg p-6">
                  ...
                  <div className="mb-4">
                    ...
                    <ul className="text-cloud-white/80 text-sm space-y-1">
          ...
          <LazySection>
            <GlassCard className="mb-8">
              ...
              <div className="bg-emerald-900/20 rounded-lg p-6 mb-6">
                ...
                <div className="text-center text-cloud-white/80 text-sm">
                  <p className="mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-blue-900/20 rounded-lg p-6">
                  ...
                  <ul className="text-cloud-white/80 text-sm space-y-2">
