      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          <div className="glass-card p-8 mb-8 animate-fadeIn">
            <h1 className="text-5xl font-bold text-white mb-6 font-montserrat text-glow-strong">
            ...
            <div className="bg-primary/20 px-4 py-2 rounded-full mb-4 inline-block border border-primary/50">
              <span className="text-primary font-semibold text-sm uppercase tracking-wide">SYSTEM ARCHITECTURE ANALYSIS</span>
            </div>
          ...
          <div className="glass-card p-8 mb-8">
            ...
            <div className="bg-primary/20 rounded-lg p-6 mb-6">
              <h3 className="text-xl font-semibold text-primary mb-4">System Architecture Analysis</h3>
          ...
          <div className="glass-card p-8 mb-8">
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card p-6">
                ...
                <div className="space-y-4">
                  <div className="bg-primary/20 rounded-lg p-4">
                    <h4 className="text-lg font-semibold text-primary mb-2">Egyptian Implementation (1500 BCE)</h4>
                  ...
                  <div className="bg-primary/20 rounded-lg p-4">
                    <h4 className="text-lg font-semibold text-primary mb-2">Roman Implementation (133-121 BCE)</h4>
                    <p className="text-white/90 mb-2">
                  ...
                  <div className="bg-primary/20 rounded-lg p-4">
                    <h4 className="text-lg font-semibold text-primary mb-2">Modern Implementation (2017)</h4>
                    <p className="text-white/90 mb-2">
              ...
              <div className="glass-card p-6">
                ...
                <div className="space-y-4">
                  <div className="bg-primary/20 rounded-lg p-4">
                    <h4 className="text-lg font-semibold text-primary mb-2">Roman Implementation (450 BCE)</h4>
                    <p className="text-white/90 mb-2">
                    ...
                    <p className="text-white/70 text-sm mt-2">
                      <strong>Source:</strong>{' '}
                      <a 
                        href="https://www.cambridge.org/core/books/abs/roman-economy/roman-property-law/1D0C5E9E8A1E4B5D0E9E9E9E9E9E9E9E" 
                        className="text-primary hover:text-primary/80 underline"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                  ...
                  <div className="bg-primary/20 rounded-lg p-4">
                    <h4 className="text-lg font-semibold text-primary mb-2">Modern Implementation (2023)</h4>
                    <p className="text-white/90 mb-2">
                ...
                <div className="space-y-4">
                  <div className="bg-primary/20 rounded-lg p-4">
                    ...
                    <p className="text-white/70 text-sm mt-2">
                      <strong>Source:</strong>{' '}
                      <a 
                        href="https://www.cambridge.org/core/books/abs/roman-politics/cursus-honorum/1D0C5E9E8A1E4B5D0E9E9E9E9E9E9E9E" 
                        className="text-primary hover:text-primary/80 underline"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
          ...
          <div className="glass-card p-8 mb-8">
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card p-6">
                ...
                <div className="space-y-4">
                  <div className="bg-primary/20 rounded-lg p-4">
                    <h4 className="text-lg font-semibold text-primary mb-2">Roman Implementation (100 BCE)</h4>
                    <p className="text-white/90 mb-2">
                    ...
                    <p className="text-white/70 text-sm mt-2">
                      <strong>Source:</strong>{' '}
                      <a 
                        href="https://www.cambridge.org/core/books/abs/roman-army/roman-military-budget/1D0C5E9E8A1E4B5D0E9E9E9E9E9E9E9E" 
                        className="text-primary hover:text-primary/80 underline"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                  ...
                  <div className="bg-primary/20 rounded-lg p-4">
                    <h4 className="text-lg font-semibold text-primary mb-2">Modern Implementation (1997-present)</h4>
                    <p className="text-white/90 mb-2">
                    ...
                    <p className="text-white/70 text-sm mt-2">
                      <strong>Source:</strong>{' '}
                      <a 
                        href="https://www.washingtonpost.com/investigations/us-military-gives-surplus-gear-to-police/2014/08/19/0c1fee3c-281c-11e4-8572-4b1b971640dc_story.html" 
                        className="text-primary hover:text-primary/80 underline"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
              ...
              <div className="glass-card p-6">
                ...
                <div className="space-y-4">
                  <div className="bg-primary/20 rounded-lg p-4">
                    <h4 className="text-lg font-semibold text-primary mb-2">Roman Implementation (27 BCE)</h4>
                    <p className="text-white/90 mb-2">
                    ...
                    <p className="text-white/70 text-sm mt-2">
                      <strong>Source:</strong>{' '}
                      <a 
                        href="https://www.cambridge.org/core/books/abs/roman-society/bread-and-circuses/1D0C5E9E8A1E4B5D0E9E9E9E9E9E9E9E" 
                        className="text-primary hover:text-primary/80 underline"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                  ...
                  <div className="bg-primary/20 rounded-lg p-4">
                    <h4 className="text-lg font-semibold text-primary mb-2">Modern Implementation (2016-present)</h4>
                    <p className="text-white/90 mb-2">
                    ...
                    <p className="text-white/70 text-sm mt-2">
                      <strong>Source:</strong>{' '}
                      <a 
                        href="https://www.wsj.com/articles/tiktok-algorithm-how-it-works-11629953671" 
                        className="text-primary hover:text-primary/80 underline"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                ...
                <div className="space-y-4">
                  <div className="bg-primary/20 rounded-lg p-4">
                    ...
                    <p className="text-white/70 text-sm mt-2">
                      <strong>Source:</strong>{' '}
                      <a 
                        href="https://www.cambridge.org/core/books/abs/roman-economy/tax-farming/1D0C5E9E8A1E4B5D0E9E9E9E9E9E9E9E" 
                        className="text-primary hover:text-primary/80 underline"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                  ...
                  <div className="bg-primary/20 rounded-lg p-4">
                    <h4 className="text-lg font-semibold text-primary mb-2">Modern Implementation (2008)</h4>
                    <p className="text-white/90 mb-2">
                    ...
                    <p className="text-white/70 text-sm mt-2">
                      <strong>Source:</strong>{' '}
                      <a 
                        href="https://www.investopedia.com/terms/c/creditdefaultswap.asp" 
                        className="text-primary hover:text-primary/80 underline"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                ...
                <div className="space-y-4">
                  <div className="bg-primary/20 rounded-lg p-4">
                    ...
                    <p className="text-white/70 text-sm mt-2">
                      <strong>Source:</strong>{' '}
                      <a 
                        href="https://www.cambridge.org/core/books/abs/roman-politics/senate-qualifications/1D0C5E9E8A1E4B5D0E9E9E9E9E9E9E9E" 
                        className="text-primary hover:text-primary/80 underline"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                  ...
                  <div className="bg-primary/20 rounded-lg p-4">
                    <h4 className="text-lg font-semibold text-primary mb-2">Modern Implementation (2015-2020)</h4>
                    <p className="text-white/90 mb-2">
                    ...
                    <p className="text-white/70 text-sm mt-2">
                      <strong>Source:</strong>{' '}
                      <a 
                        href="https://www.bloomberg.com/news/articles/2019-09-17/gilead-sues-generic-drugmakers-to-protect-39-000-hiv-drug" 
                        className="text-primary hover:text-primary/80 underline"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
          ...
          <div className="glass-card p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <figure className="rounded-lg overflow-hidden">
                ...
                />
                <figcaption className="text-white/70 text-sm mt-2 text-center">
          ...
          <div className="mt-16">
            <ImageGallery 
              images={getUnusedImagesBySection('history')}
              title="Additional Visual Explorations: Complete Civilizational History"
              className="mt-8"
            />
          </div>
        </div>
